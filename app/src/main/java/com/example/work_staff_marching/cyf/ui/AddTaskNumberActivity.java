           ...
           case R.id.yes:
               ...
               OkHttp.get(AddTaskNumberActivity.this, Constant.AddWorkUserTaskNtmberServlet, map, new OkCallback<Result<String>>() {
                   ...
                   public void onResponse(Result<String> response) {
                       ...
                       commonDialog.setTitle("提示").setImageResId(R.mipmap.registersuccess).setMessage("工作人员处理的最大任务数填写功！").setOnClickBottomListener(new CommonDialog.OnClickBottomListener() {
                           @Override
