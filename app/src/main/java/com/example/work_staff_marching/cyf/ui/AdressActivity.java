...
public class AdressActivity extends BaseActivity {
    ...
    protected void init(Bundle saveInstanceState) {
        ...
        Adapter1 = new ArrayAdapter<String>(
                AdressActivity.this, R.layout.catagery_design,provinces);
        ...
        lvLeft.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Adapter2 = new ArrayAdapter<String>(
                        AdressActivity.this, R.layout.catagery_design, citys[position]);
                lvMiddle.setAdapter(Adapter2);
                provincePosition = position;
                Adapter3=null;
                lvRight.setAdapter(Adapter3);
                TextView textView=(TextView)view.findViewById(R.id.TextView);
                HomeFragment.address1String = textView.getText().toString();
        ...
        lvMiddle.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Adapter3 = new ArrayAdapter<String>(
                        AdressActivity.this, R.layout.catagery_design, countrys[provincePosition][position]);
                lvRight.setAdapter(Adapter3);
                TextView textView1=(TextView)view.findViewById(R.id.TextView);
                HomeFragment.address2String = textView1.getText().toString();
...
//             Log.v("re", textView.getText().toString());
        ...
        lvRight.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                HomeFragment.address3String = textView2.getText().toString();
                HomeFragment.addressString=HomeFragment.address1String+"-"+HomeFragment.address2String+"-"+HomeFragment.address3String;
