...
public class TaskHandledDetailActivity extends BaseActivity {
    ...
    protected void init(Bundle saveInstanceState) {
        ...
        OkHttp.get(TaskHandledDetailActivity.this, Constant.get_showtaskl, map, new OkCallback<Result<TaskBean>>() {
            @Override
        ...
        contentLineaeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(TaskHandledDetailActivity.this, ContentSureActivity.class);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.dailphone:
                ...
                intent1.setClass(TaskHandledDetailActivity.this,PhoneCallActivity.class);
