...
public class ChangeAddressActivity extends BaseActivity {
    ...
    protected void init(Bundle saveInstanceState) {
        ...
        Adapter1 = new ArrayAdapter<String>(
                ChangeAddressActivity.this, R.layout.catagery_design,provinces);
        ...
        lvLeft.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Adapter2 = new ArrayAdapter<String>(
                        ChangeAddressActivity.this, R.layout.catagery_design, citys[position]);
                lvMiddle.setAdapter(Adapter2);
                provincePosition = position;
                Adapter3=null;
                lvRight.setAdapter(Adapter3);
                TextView textView=(TextView)view.findViewById(R.id.TextView);
                ChangeOnlinePetitionActivity.address1String = textView.getText().toString();
        ...
        lvMiddle.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Adapter3 = new ArrayAdapter<String>(
                        ChangeAddressActivity.this, R.layout.catagery_design, countrys[provincePosition][position]);
                lvRight.setAdapter(Adapter3);
                TextView textView1=(TextView)view.findViewById(R.id.TextView);
                ChangeOnlinePetitionActivity.address2String = textView1.getText().toString();
            }
        });
        lvRight.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                ChangeOnlinePetitionActivity.address3String = textView2.getText().toString();
                ChangeOnlinePetitionActivity.addressString=ChangeOnlinePetitionActivity.address1String+"-"+ChangeOnlinePetitionActivity.address2String+"-"+ChangeOnlinePetitionActivity.address3String;
                setResult(RESULT_OK);
                finish();
            }
        });
